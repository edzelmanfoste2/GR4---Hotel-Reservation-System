...
public class room104 extends JFrame implements ActionListener{
...
//BackButton
        ...
        hdr = new JLabel("ROOM 104 - TWIN ROOM");
        hdr.setBounds(120, 40, 900, 40);
...
//Price
        ...
        price = new JLabel();
      price.setText(" P5,000 per night");
...
//INCLUSIONS
        ...
        layout.add(inclusions);
         ...
         includetails = new JLabel("<html>   - 2 twin beds with high-quality linens<br>" +
"  - En-suite bathroom with shower<br>" +
"  - Work desk with chair</html>");
...
"  - Access to fitness center and swimming pool</html>");
        ...
        layout.add(Facilitiesdetails);
          ...
          ImageIcon LogoIcon = new ImageIcon("Pictures/104.png");
        ...
        setSize(700, 700);
        setTitle("Room 103 - Standard Room");
        setLayout(null);
        setVisible(true);
        setResizable(false);
