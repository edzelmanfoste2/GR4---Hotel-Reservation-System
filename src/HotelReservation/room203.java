...
public class room203 extends JFrame implements ActionListener{
...
//BackButton
        ...
        hdr = new JLabel("ROOM 203 - PRESIDENTIAL SUITE");
...
//Price
        ...
        price = new JLabel();
      price.setText(" P20,000 per night");
...
//INCLUSIONS
        ...
        layout.add(inclusions);
         ...
         includetails = new JLabel("<html>  - 1 king bed with premium bedding<br>" +
...
"  - Private butler service</html>");
        ...
        layout.add(Facilitiesdetails);
          ...
          ImageIcon LogoIcon = new ImageIcon("Pictures/203.png");
        ...
        setSize(700, 700);
        setTitle("Room 202 - Presidential Suite");
        setLayout(null);
        setVisible(true);
        setResizable(false);
