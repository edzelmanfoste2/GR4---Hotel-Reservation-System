...
public class room103 extends JFrame implements ActionListener{
...
//BackButton
        ...
        hdr = new JLabel("ROOM 103 - STANDARD ROOM");
...
//Price
        ...
        price = new JLabel();
      price.setText(" P4,500 per night");
...
//INCLUSIONS
        ...
        layout.add(inclusions);
         ...
         includetails = new JLabel("<html>  - 1 queen bed with comfortable bedding<br>" +
...
"  - Access to fitness center and swimming pool</html>");
        ...
        layout.add(Facilitiesdetails);
          ...
          ImageIcon LogoIcon = new ImageIcon("Pictures/103.png");
