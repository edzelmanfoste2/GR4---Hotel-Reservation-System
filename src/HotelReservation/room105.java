...
public class room105 extends JFrame implements ActionListener{
...
//BackButton
        ...
        hdr = new JLabel("ROOM 105 - SINGLE ROOM");
...
//Price
        ...
        price = new JLabel();
      price.setText(" P3,500 per night");
...
//INCLUSIONS
        ...
        layout.add(inclusions);
         ...
         includetails = new JLabel("<html>   - 1 single bed with comfortable bedding<br>" +
...
"  - Access to fitness center and swimming pool</html>");
        ...
        layout.add(Facilitiesdetails);
          ...
          ImageIcon LogoIcon = new ImageIcon("Pictures/105.png");
